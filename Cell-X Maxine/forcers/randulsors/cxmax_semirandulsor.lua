name = "CX-Max Semi-Randulsor"
id = "CXMAX_SEMIRANDULSOR"
author = "traincrisis"
texture = "cxmax_semirandulsor.png"
updateIndex = 18000
...
function Step(this)
    ...
    local function CanPull(this)
        for i = 0, 3 do
            if i == 1 or i == 3 then -- Only check front (1) and back (3) directions

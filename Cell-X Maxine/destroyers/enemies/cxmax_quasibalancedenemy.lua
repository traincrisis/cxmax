name = "CX-Max Quasi-Balanced Enemy"
id = "CXMAX_QUASIBALANCEDENEMY"
author = "traincrisis"
texture = "cxmax_quasibalancedenemy.png"
updateIndex = 9000
...
function Push(this, dir, bias)
    ...
    grid.CreateCell("CXMAX_QUASIWEAKENEMY", x, y, this.direction)
        return {false, true}
    else
